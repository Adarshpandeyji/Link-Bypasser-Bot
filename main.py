...
# bot
bot_token = os.environ.get("TOKEN", "6035784033:AAG0EOwrP1jCqsOdKSWrhwNtdHSEniGVgV0")
api_hash = os.environ.get("HASH", "ee9172964fda7050eed58701c7ff8917") 
api_id = os.environ.get("ID", "7273627")
